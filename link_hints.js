...
(function() {
  var COPY_LINK_URL, LinkHints, OPEN_INCOGNITO, OPEN_IN_NEW_WINDOW, OPEN_IN_CURRENT_TAB, OPEN_IN_NEW_BG_TAB, OPEN_IN_NEW_FG_TAB, OPEN_WITH_QUEUE, alphabetHints, filterHints, numberToHintString, root, spanWrap;
  ...
  LinkHints = {
    ...
    activateModeToOpenInNewWindow: function() {
      return this.activateMode(OPEN_IN_NEW_WINDOW);
    },
    ...
    setModeToOpenInNewWindow: function() {
      this.setOpenLinkMode(OPEN_IN_NEW_WINDOW);
    },
    setMode: function() {
    ...
    setOpenLinkMode: function(mode) {
      ...
      } else if (this.mode === OPEN_IN_NEW_WINDOW) {
        return this.linkActivator = function(link) {
          return chrome.runtime.sendMessage({
